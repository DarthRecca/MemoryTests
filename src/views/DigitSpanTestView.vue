<template>
	...
	<div class="instructions" v-if="!this.testStartFlag && !this.trialStartFlag && !this.trialCompleted">
		...
		<p>
			In this experiment, you will be shown a sequence of numbers on the screen. These
			numbers are called digits.<br /> You need to remember the sequence and enter it into the
			space provided on the screen when prompted.<br />
			If you make mistakes while entering the sequence, you can correct the last mistake
			using the Clear button.<br /> Once you have entered all of the digits, press the ENTER
			button.<br />
			The length of the digit sequence will start from 2 and will increase until you are no
			longer able to remember it.<br /> You will be given three trials for each length.<br /> If you
			successfully complete two of the three trials for a given length, you will move on to
			the next length. Otherwise, the test will end.<br />
		</p>
		<br />
	</div>
