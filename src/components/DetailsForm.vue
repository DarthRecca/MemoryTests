		...
		<v-sheet color="teal-lighten-3" class="detail-form">
			...
			<div>
				<p>
					...
					Please provide your details so that we can inform your results in terms of where do you stand with respect to individuals of similar age and education.<br />
