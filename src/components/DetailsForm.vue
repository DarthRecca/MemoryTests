	...
	<v-container>
		<v-sheet color="teal-lighten-3" class="detail-form">
			...
			<v-form>
				...
				<v-select v-model="yearOfBirth" label="Year of Birth" :rules="[rules.required]" :items="years"
			...
			<div class="next-button">
				<v-btn size="x-large" block color="red-lighten-3" rounded="lg" @click="this.formCompleted()"
					:loading="dialog">
					Next
				</v-btn>
			</div>
				...
				<v-card title="Form Validation">
					<v-card-text>
						<div v-if="!this.formCompletedFlags.name">
							<p>
								Please enter a Name. A dummy name may be used<br />
							</p>
						</div>
						<div v-if="!this.formCompletedFlags.email">
							<p>
								Please enter an email-ID<br />
							</p>
						</div>
						<div v-if="!this.formCompletedFlags.gender">
							<p>
								Please choose a gender option<br />
							</p>
						</div>
						<div v-if="!this.formCompletedFlags.year">
							<p>
								Please enter your Birth Year<br />
							</p>
						</div>
						<div v-if="!this.formCompletedFlags.month">
							<p>
								Please enter your Birth Month<br />
							</p>
						</div>
						<div v-if="!this.formCompletedFlags.location">
							<p>
								Please enter the location where you are giving this exam from<br />
							</p>
						</div>
						<div v-if="!this.formCompletedFlags.device">
							<p>
								Please enter the type of device you are using<br />
							</p>
						</div>
						<div v-if="!this.formCompletedFlags.education">
							<p>
								Please select your highest education level<br />
							</p>
						</div>
						<div v-if="!this.formCompletedFlags.consent">
							<p>
								Please give your consent to give this test<br />
							</p>
						</div>
					</v-card-text>
				</v-card>
